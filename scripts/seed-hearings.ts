...
const MA_LEGISLATURE_HEARINGS = [
  ...
  {
    title: 'FY2027 Senate Budget Debate (S.4) — May 19–21, 2026',
    eventType: 'Budget Milestone',
    hearingType: 'BUDGET' as const,
    date: new Date('2026-05-19T10:00:00'),
    time: '10:00 AM (Tue–Thu, May 19–21)',
    location: 'Senate Chamber, State House, Boston, MA',
    committeeOrBody: 'Massachusetts Senate',
    jurisdiction: 'MASSACHUSETTS' as const,
    status: 'UPCOMING' as const,
    summary: 'Senate floor debate on the FY2027 budget (S.4) — Tuesday, May 19 through Thursday, May 21, 2026 (3-day window). Verified via the Senate order adopted May 4, 2026 placing S.4 in the Orders of the Day. Amendments to include or increase MassCEO funding will be considered (earmark within line item 7007-0300). A $200K Senate amendment for MassCEO is pending (Senate Ways & Means version was $0; House passed $25K via Gentile #462).',
