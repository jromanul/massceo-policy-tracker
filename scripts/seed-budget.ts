...
const BUDGET_ITEMS: BudgetSeedItem[] = [
  // ── FY2025 — First appropriation for MassCEO ──────────────────────────
  {
    ...
    amountAdopted: 200000,
    status: 'ADOPTED',
    statusDate: '2024-07-29',
    significanceToMassCEO: "First dedicated state funding for MassCEO — $200,000 earmark within line item 7007-0300 (Massachusetts Office of Business Development). Funded initial staffing, technical assistance, and outreach on employee ownership transitions.",
    notes: "For the operation of the Massachusetts Center for Employee Ownership to provide technical assistance and education regarding employee ownership transitions. $200K earmark within line item 7007-0300 of the FY25 General Appropriations Act (Ch. 140 of the Acts of 2024 / H.4800). Governor signed FY25 budget July 29, 2024.",
    sourceUrl: 'https://malegislature.gov/Budget/FY2025/FinalBudget',
    sourceExternalId: 'ma-budget-7002-1075-fy25-final',
    stages: [
      { stage: 'GOVERNOR', amount: 200000, notes: "Governor's FY2025 budget proposal", sourceUrl: 'https://budget.digital.mass.gov/govbudget/fy25/' },
      { stage: 'HOUSE', amount: 200000, notes: 'House Ways & Means FY2025 budget', sourceUrl: null },
      { stage: 'SENATE', amount: 200000, notes: 'Senate Ways & Means FY2025 budget', sourceUrl: null },
      { stage: 'CONFERENCE', amount: 200000, notes: 'Conference committee FY2025', sourceUrl: null },
      { stage: 'FINAL', amount: 200000, notes: 'Enacted FY2025 General Appropriations Act. Signed July 29, 2024.', sourceUrl: 'https://malegislature.gov/Budget/FY2025/FinalBudget' },
    ],
  },
  ...
  // ── FY2026 — Second year of MassCEO funding ───────────────────────────
  {
    ...
    significanceToMassCEO: "Level-funded at $200,000 (earmark within line item 7007-0300, Massachusetts Office of Business Development). COWOP had requested $685K. Supports growing technical assistance program and regional symposia.",
    notes: "For the operation of the Massachusetts Center for Employee Ownership. Level-funded at $200,000 (earmark within line item 7007-0300, Massachusetts Office of Business Development) — COWOP had requested $685K. FY26 General Appropriations Act (Ch. 9 of the Acts of 2025 / H.4240). Governor signed FY26 budget July 4, 2025.",
    sourceUrl: 'https://malegislature.gov/Budget/FY2026/FinalBudget',
    sourceExternalId: 'ma-budget-7002-1075-fy26-final',
    stages: [
      { stage: 'GOVERNOR', amount: 200000, notes: "Governor's FY2026 budget proposal", sourceUrl: 'https://budget.digital.mass.gov/govbudget/fy26/' },
      { stage: 'HOUSE', amount: 200000, notes: 'House Ways & Means FY2026 budget', sourceUrl: null },
      { stage: 'SENATE', amount: 200000, notes: 'Senate Ways & Means FY2026 budget', sourceUrl: null },
      { stage: 'FINAL', amount: 200000, notes: 'Enacted FY2026 General Appropriations Act. Signed July 4, 2025.', sourceUrl: 'https://malegislature.gov/Budget/FY2026/FinalBudget' },
    ],
  },
  ...
  for (const item of BUDGET_ITEMS) {
    ...
    const budgetItem = await prisma.budgetItem.create({
      data: {
        ...
        priorYearAmount: item.fiscalYear === 2025 ? null : new Prisma.Decimal(200000),
